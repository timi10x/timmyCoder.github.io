  ...
  return (
    <>
      ...
      <div className="fixed inset-0">
        ...
        {/* Subtle moving light beam — pure CSS */}
        <div className="absolute top-0 left-0 w-px h-full bg-gradient-to-b from-transparent via-gray-200 to-transparent opacity-20 animate-beam" />
      </div>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-blue-200 rounded-full opacity-10 blur-3xl animate-float-orb-1" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-purple-200 rounded-full opacity-10 blur-3xl animate-float-orb-2" />
      </div>
    </>
  )
}
